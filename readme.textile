...
The impex mess is over guys, enjoy your hybris projects with a nice ruby api for impex generation!
...
* cleanup
* make generation dynamic 
* think about supporting of different formats as input (xml, json, csv) 
