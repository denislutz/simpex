...
The impex factory for standard hybris types will make it possible to create a valid hybris db setup only with ruby, so no impex knowledge is necessary at all. 
This is very convinient for hybris test fixtures setup and the initial product import.
